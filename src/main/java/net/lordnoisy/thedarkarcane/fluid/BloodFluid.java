...
public abstract class BloodFluid extends FlowableFluid {
    ...
    public Fluid getFlowing() {
        return ModFluids.BLOOD_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.BLOOD_STILL;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModBlocks.BLOOD_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.BLOOD_STILL || fluid == ModFluids.BLOOD_FLOWING;
    }
